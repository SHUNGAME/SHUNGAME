...
public class getselectquestion {
	private Context context;

	public getselectquestion(Context context){
		// TODO Auto-generated constructor stub
		this.context = context;
	}
	
	public Map<String, String> getselectquestionMap(String[] args){
		Map<String, String> map = new HashMap<String, String>();
		getsqldatabase getsql = new getsqldatabase(context);
		SQLiteDatabase database = getsql.opensqlDatabase();
		Cursor cursor = database.rawQuery(
				"select * from selectquestion where id=?", args);
